...
'''
#my functions 
#os.chdir("/import/bc_workspaces/biodiv/miranda/ABM")
...
def simulations(num_simus,type_sim):     
    ...
    for i in range(num_simus): 
        ...
        community = []     
        #runs update    
        update(nrow, main, species_list, max_time_steps, rep, mainland_island, resources_island, community, type_sim, Plant,resources_environment, ques )#"sim_RAMI_50_SPS_10_ANS", Plant,resources_environment, ques )
...
def update(nrow,  main, species_list, max_time_steps, rep, mainland_island, resources_island, community, type_sim, Plant,resources_environment, ques ):    
    ...
    while current_time_step < max_time_steps:
        ...
        #---------- export data chunk 
        data_fast_append(community, mainland_island, current_time_step,rep, plants_down_for_competition[1],resources_island, type_sim )
        current_time_step += 1         
